...
describe('should render ExampleCommentsPage', () => {
  ...
  test('no data given as props', () => {
    const wrapper = shallow(<ExampleCommentsPage paginationData={defaultData} />)
    expect(wrapper).toMatchSnapshot()
  })

  test('with given comments and fake action to return comments', () => {
    const wrapper = shallow(<ExampleCommentsPage exampleComments={comments} paginationData={defaultData} loadExampleComments={jest.fn()} />)
    expect(wrapper).toMatchSnapshot()
  })
  ...
  test('with an error in data from loadExampleComments',  () => {
    ...
    const wrapper = shallow(<ExampleCommentsPage exampleComments={[]} paginationData={defaultData} loadExampleComments={myMock} />)
    expect(wrapper).toMatchSnapshot()
  })
  ...
  test('with given empty list', () => {
    const wrapper = shallow(<ExampleCommentsPage exampleComments={[]} paginationData={defaultData} loadExampleComments={jest.fn()} />)
    expect(wrapper).toMatchSnapshot()
  })
