          ...
          <div className={'row'}>
            ...
            <div className={'columns text-right'}>
              <div className={'page-main-nav'}>
                <p>
                  <strong>{this.totalRecords}</strong>&nbsp;{this.props.recordsName}&nbsp;Found
                </p>
                <div className={'page-navigation-bar'}>
                                <span className={'page-total-info'}>
                                  Page <span>{ currentPage }</span> / <span>{ this.totalPages }</span>
                                </span>
                    ...
                    { pages.map((page, index) => {
                      ...
                      if (page === LEFT_PAGE) return (
                        <li key={index} className='page-item'>
                          <a className='page-link' role='button' aria-label='Previous' onClick={this.handleMoveLeft}>
                      ...
                      if (page === RIGHT_PAGE) return (
                        <li key={index} className='page-item'>
                          <a className='page-link' role='button' aria-label='Next' onClick={this.handleMoveRight}>
                      ...
                      return (
                        <li key={index} className={`page-item${ currentPage === page ? ' active' : ''}`}>
                          <a className='page-link' role='button' onClick={ this.handleClick(page) }>{ page }</a>
                        </li>
                      )
