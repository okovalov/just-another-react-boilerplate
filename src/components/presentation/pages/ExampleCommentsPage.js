...
import { getExampleComments, getCommentsPaginationData } from '../../../store/selectors/exampleCommentSelectors'
...
export class ExampleCommentsPage extends Component {
  ...
  renderPagination = () => {
    const {currentPage, pageLimit, totalRecords, currentItems } = this.props.paginationData
